...
const page = () => {
  return (
    ...
    <div className="lolo1">
        <h2 className="lolo2">Suzuki Swift 2024 Price in Pakistan, Images, Reviews & Specs</h2>
        <div className="main2"><img className='lolo'
                src="https://pak-wheels-next-app.vercel.app/_next/image?url=%2FSwift.jpg&w=750&q=75"></img>
        </div>
        <div className="main3">
        ...
        <div className="main16">
            <p className="main17">PKR 45,50,000</p>
        </div>
