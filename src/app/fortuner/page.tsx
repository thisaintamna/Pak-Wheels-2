...
const page = () => {
  return (
    <div>
     <Header></Header>
       <div className="lolo1">
        <h2 className="lolo2">Honda Civic 2024 Price in Pakistan, Images, Reviews & Specs</h2>
        <div className="main2"><img className='lolo'
                src="https://pak-wheels-next-app.vercel.app/_next/image?url=%2FCivic.jpg&w=750&q=75"></img>
        </div>
        <div className="main3">
        ...
        <div className="main16">
            <p className="main17">PKR 70,50,000</p>
        </div>
